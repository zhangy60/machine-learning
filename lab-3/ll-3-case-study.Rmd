...
knitr::opts_chunk$set(echo = TRUE, eval = TRUE) #echo is to show the code, eval is to run the codes, when changed to false, it won't run the codes. Can set the chunk argument. By default, it's true. Can set cache and warning equal to true too.
```
