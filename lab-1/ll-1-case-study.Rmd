...
-   number of cases where .pre_class == code is true and false,
    respectively.
...
-   Accuracy is the percent of correct decision, where .pred_class ==
    code is true. In this case 87% correctness is pretty good.

-   AUC is the area under the ROC curve, which represents how well the
    model distinguish the positive cases from negative cases. When AUC
    is close to 1, the model performs well in distinguishing between
    positive and negative cases. .93 is a pretty good AUC value. The
