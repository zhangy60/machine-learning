...
- How many sets (samples taken through resampling)?
    ...
    - When _k_ is equivalent to the number of rows in the data, this is often called "Leave One Out Cross-Validation" (LOOCV). For smaller sample size, i.e., 500, 800. may set k=number of rows.
---
